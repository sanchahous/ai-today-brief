...
1. **Озвучка без аватара** — весь епізод голосом, нікого в кадрі: N текстів → N аудіофайлів,
   ціль ~5 хв.
2. **Озвучка з аватаром** — той самий випуск, але в кількох місцях (типово інтро / радар /
   фінал) з'являється ведучий; середину читає голос із кроку 1. Якщо аватар цього тижня не
   потрібен — крок пропускається.
