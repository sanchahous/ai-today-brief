...
Окремим повідомленням після карток приходить **🖼 ПРОМПТ ОБКЛАДИНКИ** — Canonical /
Midjourney / Negative в блоках `<pre>` (копіюється одним тапом). Це не картинка: згенеруй
обкладинку у своєму інструменті. Автоматично малюються лише картки новин на сайті.
