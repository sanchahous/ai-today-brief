# Video — редакційна планка (ведучий + жива сцена новини)
...
- ведучого на інтро / радар / аутро (PiP);
...
1. **Голос** веде історію (закадр або губи аватара на інтро/аутро).
2. **Ведучий** з'являється як людина в кадрі на відкритті й закритті — довіра, не весь екран.
3. **Задній план — подія новини в русі**: image-to-video з ілюстрації *цієї* історії, або
...
екрані; людини в кадрі не було. Корінь: `durationSeconds` вигадував LLM під 360–480 с, а реальний
...
7. Аватар ≠ весь кадр: PiP 20–25% площі; контент головний.
...
`weekly-video-v3` маніфест: cold open → anchor → b-roll на кожну Top 3 історію → radar →
...
Рендерер (`ai-today-brief-video`): озвучка, аватар-кліпи, живий фон, Remotion, YouTube,
...
Автоматизацію YouTube/HeyGen свідомо не робимо, доки не пройдуть 1–2 ручні випуски.
