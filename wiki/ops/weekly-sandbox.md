...
Політика планування з 2026-08-23 — `weekly-semantic-story-v6` (fixture без `policyId`
бере цей id). Semantic-поля ті самі, що у v5.1: original summary/why/practical/limitation/
