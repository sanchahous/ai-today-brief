...
social package LinkedIn recovery, GitHub dispatch 503 recovery та staged social checkpoints
2026-08-17
...
| ✅ [pipeline/weekly-digest](pipeline/weekly-digest.md) | Weekly Content Studio v2, durable workers, linked-retry social checkpoints, semantic story images v5.1, spend ledger і admin UX | `.env.example` + PR #160–#177/#208/#209/#222 + `card-image.ts` + `generation-worker.ts` |
...
| ✅ [ops/weekly-admin-runbook](ops/weekly-admin-runbook.md) | Як вести weekly у `/admin/weekly`: вкладки, social package, succeeded≠approved, staged resume, stuck jobs і GitHub 503 recovery | нове 2026-08-04, оновлено 2026-08-17 |
