...
LinkedIn 7-page overflow bounds, approval-ready Social repair та bounded social provider ladder
2026-08-17
...
| ✅ [pipeline/weekly-digest](pipeline/weekly-digest.md) | Weekly Content Studio v2, durable workers, linked-retry social checkpoints, bounded 7-page LinkedIn document, semantic story images v5.1, spend ledger і admin UX | `.env.example` + PR #160–#177/#208/#209/#222 + `card-image.ts` + `generation-worker.ts` + `linkedin-document.ts` |
