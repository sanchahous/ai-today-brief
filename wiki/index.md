...
| 📋 `architecture/data-model.md` | Схема Supabase, RLS, 102 міграцій, `database.types.ts` | `supabase/migrations/**` + live check |
...
| ✅ [ops/supabase-egress-2026-09](ops/supabase-egress-2026-09.md) | Free egress 15/5 GB; Pro до 21 Sep; #350 SSG categories 2063→30; skip `.gitignore`/`library`; Sonar `build:ci` | Usage Dashboard + edge_logs 2026-09-02 |
