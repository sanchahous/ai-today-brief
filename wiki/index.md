...
| ✅ [ops/supabase-egress-2026-09](ops/supabase-egress-2026-09.md) | Free uncached egress 15 GB / 5 GB: три `next build` проти PostgREST; Data Cache + e2e prerender cap | Usage Dashboard + edge_logs 2026-09-02 |
