...
**Базується на:** [`LINKEDIN-STRATEGY-2026.md`](./LINKEDIN-STRATEGY-2026.md) + мультиагентне ревью 18–19.07.2026 (верифікація ~40 тверджень: 0 спростовано; адверсарний скептик-пас критики)<br>
**Формат:** чек-лісти в порядку виконання. Робити зверху вниз. Якщо тиждень «просів» — деградувати за драбиною з розділу «Правила».

> Стратегія (позиціонування, формули постів, guardrails, вимоги до CMS) залишається в `LINKEDIN-STRATEGY-2026.md`. Цей файл — тільки «що робити руками і в якому порядку», з поправками ревью:
