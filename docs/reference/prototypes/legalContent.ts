/**
 * Template legal copy for the prototype: Privacy (GDPR-shaped), Terms, and an
 * AI-disclosure aligned with EU AI Act art. 50 (applicable 2026-08-02).
 *
 * ⚠️ These are TEMPLATES, not legal advice. Bracketed [placeholders] mark
 * details a real launch must fill, and every page renders a visible "needs a
 * lawyer" banner. I'm an engineer, not a lawyer — this gives the structure and
 * honest first-draft wording, to be reviewed by counsel before publishing.
 */
...
const PRIVACY: LegalDoc = {
  ...
  updated: '2026-06-01',
  intro: {
    uk: 'Ця політика пояснює, які персональні дані збирає [оператор даних] на сайті AI Brief, з якою метою та як ви можете ними керувати. Контролер даних: [юридична назва], [адреса]. Контакт: [email].',
    en: 'This policy explains what personal data [data controller] collects on AI Brief, why, and how you can control it. Data controller: [legal name], [address]. Contact: [email].',
  },
  sections: [
    {
...
const TERMS: LegalDoc = {
  ...
  updated: '2026-06-01',
  intro: {
    uk: 'Користуючись AI Brief, ви погоджуєтесь із цими умовами. Сервіс надає [юридична назва]. Якщо ви не згодні — будь ласка, не користуйтесь сайтом.',
    en: 'By using AI Brief you agree to these terms. The service is provided by [legal name]. If you do not agree, please do not use the site.',
  },
  sections: [
    {
      ...
      body: [
        {
          uk: 'AI Brief — інформаційний дайджест. Ви погоджуєтесь не зловживати сервісом, не намагатись зламати чи перевантажити його та не використовувати автоматичний збір даних без дозволу.',
          en: 'AI Brief is an informational digest. You agree not to abuse the service, attempt to break or overload it, or scrape it without permission.',
        },
      ],
    },
    {
