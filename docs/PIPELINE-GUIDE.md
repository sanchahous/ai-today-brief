...
| `MAX_EMBED_DISTANCE` | 0.20 | чутливість дедуплікації (менше = суворіше) |

---

## 9. Глосарій

- **Прогін (progón)** — один цикл pipeline. 6 на день (кожні 4 год Київ), у кожного 6 retry-слотів через 30 хв.
