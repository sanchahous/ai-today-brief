...
-- Job locale is carried in the durable JSON input. The v2 claim function
-- previously referenced a non-existent relational column, which prevented
-- every queue claim before the dependency case expression could be evaluated.
