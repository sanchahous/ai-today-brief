...
name: ui-ux-pro-max
description: >
  AI design intelligence: styles, palettes, typography, UX guidelines, charts,
  stack-specific rules. Use for UI/UX design, review, accessibility, design
  systems, landing pages, or polishing study-platform day-view.
---
...
**This repo:** run commands from monorepo root (`domains/portfolio`). For **study-platform** use `--stack react`. Existing tokens: `apps/study-platform/design-system/`.
